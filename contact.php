<script src='Controller/page/cContact.js'></script>
<div style="margin-bottom: 5px;" class="panel panel-u">
         <div class="panel-heading">
         <h3 class="panel-title"><i class="fa fa-tasks"></i> ติดต่อเรา</h3>
         </div>
         <div class="panel-body">
               ...
               <div class='col-xs-7'>
               			...
               			<form name="contactUsForm" id="contactUsForm" action="#" class="sky-form">
							<fieldset>                  
										<section>
											<label class="label">ประเภทการติดต่อ</label>
											<label class="input">
												<select name='contact_title' id='contact_title'>
												
													<option value='0'>กรุณาเลือกหัวข้อการติดต่อ </option>
													<option>แจ้งปัญหา </option>
													<option>ขอความช่วยเหลือการใช้งาน </option>
													<option>แสดงความคิดเห็น </option>
													<option>ให้ขอเสนอแนะ </option>
													<option>ติดต่อเรื่องการโฆษณา </option>
													<option>ปัญหาทางเทคนิค </option>
													<option>การใช้งานเว็ปไซต์ </option>
							...
							<button type="submit" id="btnContactUsForm" class="btn-u">ส่งข้อความ</button>
               		...
               		<div class='col-xs-5'>
		                ...
		                <ul class="list-unstyled who margin-bottom-30">
		                    ...
		                    <li><a href="#"><i class="fa fa-envelope"></i>ติดต่อเว็ปไซต์  :  อีเมล์  :  info@realthairealty.com  </a></li>
		                    <li><a href="#"><i class="fa fa-phone"></i>ติดต่อฝ่ายขาย : อีเมล์ : sale@realthairealty.com <br>( ทุกวัน 10.00-18.00 น.) โทรศัพท์  : +6692-796-6556  </a></li>
		                    <li><a href="#"><i class="fa fa-globe"></i>ติดต่อทีมงาน:  อีเมล์  : webmaster@realthairealty.com </a></li>
		                    <li><a href="#"><i class="fa fa-globe"></i>ติดต่อฝากข่าวสาร  : support@realthairealty.com</a></li>
		              
		                </ul>
		                -->
		                การติดต่อทีมงาน realthairealty.com<br>

เพื่อสอบถามปัญหาการใช้งาน ข้อคิดเห็น ขอความช่วยเหลือ และให้ข้อเสนอแนะเว็ปไซต์ ท่านสามารถกรอบแบบฟอร์มด้านล่างเพื่อส่งข้อความและข้อมูลถึงทีมงานของเราได้ทันที หรือ ท่านสามารถ อีเมลมาที่ info@realthairealty.com 
