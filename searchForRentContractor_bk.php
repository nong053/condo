                               ...
                               <form class="sky-form" id="sky-form4" action="#" novalidate="novalidate">
									<header>
										<div class="headline headline-md">
											<h2>ค้นหาประกาศเช่าสำหรับผู้หรับเหมา</h2>
										</div>
										<button type="button" class="btn-u btn-mainmenu-contractor ">เช่าวัสดถก่อสร้าง</button>
										<button type="button" class="btn-u btn-mainmenu-contractor">เช่าเครื่องมือก่อสร้าง</button>
										<button type="button" class="btn-u btn-mainmenu-contractor ">เช่าเฟอร์นิเจอร์ </button>
										<button type="button" class="btn-u btn-mainmenu-contractor "> ผู้รับเหมาก่อสร้างทั่วไป</button>
										<button type="button" class="btn-u btn-mainmenu-contractor">ผู้รับเหมาตกแต่ง</button>
										<button type="button" class="btn-u btn-mainmenu-contractor ">ผู้รับเหมาฐานราก </button>
...
ี
									...
									<footer>
										<button class="btn-u btn-u-light-green" type="submit"><i class="fa fa-envelope-o"></i>บันทึกการค้นหา</button>
										<button class="btn-u btn-u-dark-blue" type="submit"><i class="fa fa-envelope-o"></i>แจ้งเตือนทางอีเมลล์</button>
										<button class="btn-u btn-u-orange" type="submit "><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ค้นหาประกาศ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
									</footer>
								</form>