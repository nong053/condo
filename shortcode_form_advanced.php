                ...
                <ul class="loginbar pull-right">
                    <li class="hoverSelector">
                        ...
                        <ul class="languages hoverSelectorBlock">
                            <li class="active">
                                <a href="#">ไทย <i class="fa fa-check"></i></a> 
                            </li>
                    ...
                    <li><a href="page_faq.html">ช่วยเหลือ</a></li>  
                    <li class="topbar-devider"></li>   
                    <li><a href="page_login.html">ลงชื่อเข้าใช้งาน</a></li>   
                </ul>
            </div>
            <!-- End Topbar -->
                                        ...
                                        <div class="row equal-height">
                                            ...
                                            <div class="col-md-3 equal-height-in">
                                                <ul class="list-unstyled equal-height-list">
                                                    ...
                                                    <li class="active"><a href="shortcode_form_advanced.html"><i class="fa fa-bars"></i> Advanced Forms</a></li>
                        ...
                        <div class="search-open">
                            <div class="input-group animated fadeInDown">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn-u" type="button">คลิ๊ก</button>
                                </span>
                            </div>
                        </div>    
                    </li>
