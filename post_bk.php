										...
										<div class="tab-pane fade in active" id="mainData">
													 ...
													 <form role="form" id="formRealtyDataGe" name="formRealtyDataGe" class="form-horizontal" action="#">
														...
														<div class="form-group">
															...
															<div class="form-group newProjectRealty">
																<label class="col-lg-3 control-label" for="rdg_owner_project"> ที่อยู่โครงการ  </label>
																<div class="col-lg-9">
																	<textarea placeholder="ทีอยู่โครงการ" id="rdg_owner_project" name="rdg_owner_project" class="form-control"></textarea>
																</div>
															</div>
															<div class="form-group newProjectRealty">
																<label for="rdg_price" class="col-lg-3 control-label"> ราคาโครงการเริ่มต้น </label>
																<div class="col-lg-5">
																	<input type="text" class="form-control" name="rdg_price" id="rdg_price" placeholder="ราคา">
																</div>
															</div>
															...
															<div class="headline"><h4>ข้อมูลด้านราคา</h4></div>
																	...
																	<div class="form-group">
																		<label class="col-lg-3 control-label" for="rdg_price"> ราคาเช่า </label>
																		<div class="col-lg-5">
																			<input type="text" placeholder="ราคา" id="rdg_price" name="rdg_price" class="form-control">
																		</div>
																	</div>
															...
															<div class="headline"><h4>ข้อมูลด้านการเเดินทาง(ในเขตกรุงเทพและปริมณฑล)</h4></div>
																	...
																	<div class="form-group">
																		<label class="col-lg-3 control-label" for="rdg_price"> สายรถไฟฟ้า BTS </label>
																	...
																	<div class="form-group">
																		<label class="col-lg-3 control-label" for="rdg_price"> สายรถไฟฟ้า MRT</label>
																	...
																	<div class="form-group">
																		<label class="col-lg-3 control-label" for="rdg_price"> เรือโดยสาร</label>
																		<div class="col-lg-5" id="travelByHARBORArea">
																			
																		</div>
																	</div>
																	<div class="form-group">
																		<label class="col-lg-3 control-label" for="travelByBus"> สายรถประจำทาง</label>
																		<div class="col-lg-3">
																				<input type="text" class="form-control" id="travelByBus" name="travelByBus" placeholder="สายรถประจำทางเช่น 80,113">
																		</div>
																	</div>
