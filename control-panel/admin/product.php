...
<div class="content_product">
	<div class="content_title_product"><!-- create table-->
		...
		<div class="content_3_product">บทความ</div><!-- row-->
	...
	<?PHP
	$strSQL="select * from exam where productcat_level2_id='$productcat_level2_id' ORDER BY exam_id DESC";
	...
	while($rs=mysql_fetch_array($result)){
		...
		echo"<div class=\"content_2_product\">";
			...
			if(strlen($rs[exam_name])>100){
				$exam_title=mb_substr($rs[exam_name],0,100, "UTF-8")."...";
				echo exam_name;
				}else{
				echo $rs[exam_name];
				}
		...
		echo"<a onClick=\"return confirm('คุณต้องการลบบทความนี้ ?');\" href=\"product_delete.php?action=delete&exam_id=$rs[exam_id]
...
<form action="product_process.php" method="post" enctype="multipart/form-data">
	<div class="product_manage">
			...
			<div class="product_manage_textfiled">
			 ...
			 //echo"checked";
			 ?>
 			  <input type="radio" value="Yes" name="exam_enable"  />
 			 แสดง
 			 <input name="exam_enable" type="radio" value="No"   checked="checked"/>
 			 ไม่แสดง
 			 <?php
			 }
			 ?>
		...
		<div class="prodcut_manage_title">
			<div class="product_manage_text"><b>บทความเรื่อง</b></div>
			<div class="product_manage_textfiled">
			<input type="text" name="exam_name" value="<?=$exam_name?>" size="50"/>
			</div>
			<br style="clear:both" />
		</div>
		<!--  
		...
		<div class="prodcut_manage_title">
			<div class="product_manage_text">รูปบทความ1</div>
			<div class="product_manage_textfiled">
        ...
        <div class="prodcut_manage_title">
			<div class="product_manage_text">รูปบทความ2</div>
			<div class="product_manage_textfiled">
			  <input type="file" name="product_file[]"  />
			</div>
			<br style="clear:both" />
        ...
        <div class="prodcut_manage_title">
			<div class="product_manage_text">รูปบทความ3</div>
			<div class="product_manage_textfiled">
			  <input type="file" name="product_file[]"  />
			</div>
			<br style="clear:both" />
        ...
        <div class="prodcut_manage_title">
			<div class="product_manage_text">รูปบทความ4</div>
			<div class="product_manage_textfiled">
			  <input type="file" name="product_file[]"  />
			</div>
			<br style="clear:both" />
  ...
  <!--  <textarea cols="80" id="product_title" name="product_title" rows="10" ><?=$product_title?></textarea>-->
    ...
    <!--CKEditor-->
        ...
        <div class="prodcut_manage_title">
			<div class="product_manage_text"><b>รายละเอียด</b></div>
			<div class="product_manage_textfiled">
