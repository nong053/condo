										...
										<div class="col-md-12 shadow-wrapper">
											<div class="tag-box tag-box-v1 box-shadow shadow-effect-2">
												...
												<div class="row box-margin-top5">
													<div class="col-md-12">
														<p>
														<button data-target="#contactFormModal" data-toggle="modal" class="btn-u btn-u-xs btn-u-green" type="button" id="<?=$rsPsale['cus_id']?>"><i class="fa fa-child "></i> ติดต่อผู้ลงประกาศ</button>
														<button data-target="#mapContactModal" data-toggle="modal" class="btn-u btn-u-xs btn-u-green" type="button" id="<?=$rsPsale['rdg_id']?>"><i class="fa  fa-car"></i> แผนที่</button>
														<button data-target="#imageSlideModal" data-toggle="modal" class="btn-u btn-u-xs btn-u-green" type="button" id="<?=$rsPsale['rdg_id']?>"><i class="glyphicon glyphicon-picture"></i> ภาพสไลด์</button>
