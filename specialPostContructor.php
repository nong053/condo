 <div class="row">
	<div class="panel panel-u" style="margin-bottom: 5px;">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> ประกาศพิเศษผู้รับเหมา</h3>
                            </div>
										...
										<div class="col-md-12 shadow-wrapper">
											<div class="tag-box tag-box-v1 box-shadow shadow-effect-2">
												...
												<div class="row">
													...
													<div class="row">
													<div class="col-md-8 ">
													<h2>ประกาศพิเศษขายวัสดุก่อสร้าง รหัส 888</h2>
													</div>
													<div class="col-md-4 ">
													<button onclick="window.location.href='index.php?page=post_sub_detail'" class="box-margin-top5 box-margin-bottom5 btn-u btn-u-red btn-left-right" type="button"><i class="fa fa-building "></i> คลิ๊กรายละเอียด</button>
													</div>
												</div>
												<div class="row">
													<div class="col-md-8">
										...
										<div class="col-md-12 shadow-wrapper">
											<div class="tag-box tag-box-v1 box-shadow shadow-effect-2">
												...
												<div class="row">
													...
													<div class="row">
													<div class="col-md-8 ">
													<h2>ประกาศพิเศษผู้รับเหมา รหัส 889</h2>
													</div>
													<div class="col-md-4 ">
													<button onclick="window.location.href='index.php?page=post_sub_detail'" class="box-margin-top5 box-margin-bottom5 btn-u btn-u-red btn-left-right" type="button"><i class="fa fa-building "></i> คลิ๊กรายละเอียด</button>
													</div>
